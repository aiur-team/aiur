defmodule Aiur.PaneRPC do
  ...
  alias Aiur.{AgentChat, AgentDirectory, AgentEvents, IssueContext, IssueLog}
  ...
  def attach_conversation(identifier) when is_binary(identifier),
    do: attach_conversation(identifier, Aiur.Conversations)
  ...
  history captured by `Aiur.IssueLog`. The pane calls this
  ...
  def detach_conversation(identifier) when is_binary(identifier) do
    Aiur.Conversations.detach(%{identifier: identifier, pid: self()})
  end
