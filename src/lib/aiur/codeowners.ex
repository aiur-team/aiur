defmodule Aiur.Codeowners do
  ...
  this returns an empty list; if a team cannot be expanded, it returns an error
  so callers do not mistake unknown ownership for no owners. Use
  `authoritative?/2` when the compatibility fallback matters.
  """
