defmodule Aiur.Linear.Client do
  @moduledoc """
  ...
  @query """
  query AiurLinearPoll($projectSlug: String!, $stateNames: [String!]!, $first: Int!, $relationFirst: Int!, $after: String) {
  ...
  @query_by_ids """
  query AiurLinearIssuesById($ids: [ID!]!, $first: Int!, $relationFirst: Int!) {
