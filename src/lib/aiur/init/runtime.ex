defmodule Aiur.Init.Runtime do
  ...
  @type deps :: %{
          ...
          claude_release_status: (-> Aiur.Claude.AdapterHealth.release_status()),
          claude_version: (-> {:ok, String.t()} | {:error, term()}),
  ...
  def runtime_deps do
    %{
      ...
      claude_release_status: &Aiur.Claude.AdapterHealth.release_status/0,
