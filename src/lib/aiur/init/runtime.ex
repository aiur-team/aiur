defmodule Aiur.Init.Runtime do
  ...
  @type deps :: %{
          ...
          install_claude_app_server: (String.t() -> :ok | {:error, String.t()}),
          claude_registry_version: (-> {:ok, String.t()} | {:error, String.t()}),
          claude_version: (-> :missing | {:ok, String.t()} | {:error, String.t()}),
  ...
  def runtime_deps do
    %{
      ...
      install_claude_app_server: &Aiur.Init.ClaudeAdapter.install/1,
      claude_registry_version: &Aiur.Init.ClaudeAdapter.registry_version/0,
      claude_version: &Aiur.Init.ClaudeAdapter.version/0,
