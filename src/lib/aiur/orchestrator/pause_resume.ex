defmodule Aiur.Orchestrator.PauseResume do
  ...
  alias Aiur.Orchestrator.{DispatchPolicy, Dispatcher, OperatorMessages, Slots, State}
  require Logger
  ...
  defp pause_running_or_inactive(state, running_entry, issue_identifier) do
    if State.deactivated_running_entry?(running_entry) do
      ...
      {reply, Orchestrator.transition_control_status(state, running_entry, :paused, "operator.pause")}
    end
  end
