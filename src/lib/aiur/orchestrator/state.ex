defmodule Aiur.Orchestrator.State do
  ...
  @type t :: %__MODULE__{
          ...
          state_label_preflight_checked: boolean(),
          state_label_preflight_check_pid: pid() | nil,
          state_label_preflight_check_token: reference() | nil,
          state_label_preflight_retry_at_ms: integer() | nil,
          state_label_preflight_signature: String.t() | nil,
  ...
  defstruct [
    ...
    state_label_preflight_checked: false,
    state_label_preflight_check_pid: nil,
    state_label_preflight_check_token: nil,
    state_label_preflight_retry_at_ms: nil,
    state_label_preflight_signature: nil,
