defmodule Aiur.GitHub.ReviewThreads do
  ...
  defp fetch_unaddressed_review_thread_pages(
    ...
    case Transport.github_graphql(request_fun, token, @unaddressed_review_threads_query, variables,
           caller: :review_threads_unaddressed
         ) do
      {:ok, body} ->
