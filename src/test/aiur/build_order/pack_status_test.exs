defmodule Aiur.BuildOrder.PackStatusTest do
  ...
  test "a restarted poller keeps health generations monotonic" do
    {:ok, first} = PackStatus.start_link(name: nil, poll_on_start: false)
    ...
    assert PackStatus.health(second).generation > first_generation
  end
