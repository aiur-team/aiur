defmodule Aiur.WorkflowStoreTest do
  ...
  # that took down `CoreTest` "config defaults and validation checks" in CI run
  # 31657551337. A caller is promised `:ok | {:error, term()}`, so a dying
  # store must not exit it.
