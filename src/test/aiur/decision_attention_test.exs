defmodule Aiur.DecisionAttentionTest do
  ...
  test "writes a needs-attention alert with the operator question" do
    ...
    workspace = Path.join(System.tmp_dir!(), "aiur-decision-attention-#{System.pid()}-#{System.unique_integer([:positive])}")
    issue = %Issue{identifier: identifier, title: "Needs a decision"}
  ...
  test "remote decision resolution clears the central attention feed" do
    ...
    workspace = Path.join(System.tmp_dir!(), "aiur-decision-remote-#{System.pid()}-#{System.unique_integer([:positive])}")
  ...
  test "restart import cannot revert a differently worded structured enrichment" do
    ...
    dir = Path.join(System.tmp_dir!(), "aiur-decision-import-enriched-#{System.pid()}-#{System.unique_integer([:positive])}")
