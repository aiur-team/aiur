defmodule Aiur.LogFileTest do
  ...
  describe "configure/0" do
    setup do
      ...
      tmp_root = Path.join(System.tmp_dir!(), "aiur-logfile-test-#{System.pid()}-#{System.unique_integer([:positive])}")
  ...
  describe "apply_config_debug/0" do
    setup do
      ...
      dir = Path.join(System.tmp_dir!(), "aiur-config-debug-#{System.pid()}-#{System.unique_integer([:positive])}")
      File.mkdir_p!(dir)
