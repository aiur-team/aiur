...
**Suggested labels:** `complexity:4`, `model:codex-gpt-5.6-sol`, `phase:5`, `build-lane:accounting`; never `agent:todo`
...
- [Your implementation pointers](https://github.com/its-everdred/aiur/blob/<APPROVED_SHA>/docs/build-order/08-implementation-pointers.md) — section `DASH-024`
