...
**Suggested labels:** `complexity:3`, `model:codex-gpt-5.6-sol`, `phase:6`, `build-lane:accounting`; never `agent:todo`
...
- [Your implementation pointers](https://github.com/its-everdred/aiur/blob/<APPROVED_SHA>/docs/build-order/08-implementation-pointers.md) — section `DASH-030`
