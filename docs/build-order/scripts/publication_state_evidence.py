...
def validate_all_issue_state_evidence(
    ...
    expected = core_ids | dash_ids | skill_ids
    ...
    if observed != expected:
        report.error(
            "combined OPEN issue-state evidence must exactly cover root, BO, "
            "DASH, and skill issues"
        )
