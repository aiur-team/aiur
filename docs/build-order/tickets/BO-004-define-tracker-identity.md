...
**Suggested labels:** `complexity:3`, `model:codex`, `phase:1`, `build-lane:plan-graph`; never `agent:todo`
...
- [Your implementation pointers](https://github.com/its-everdred/aiur/blob/<APPROVED_SHA>/docs/build-order/08-implementation-pointers.md) — section `BO-004`
