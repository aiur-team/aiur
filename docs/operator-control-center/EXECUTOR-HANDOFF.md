...
The deterministic fixture validates rendering and documentation privacy. Final interactive acceptance still belongs in the operator repository root because generated issue workspaces are forbidden from running `scripts/aiurdev --test`.
