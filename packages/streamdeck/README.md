...
# Create the file only if it does not exist; preserve brightness on reruns.
...
These hardware steps need the direct-HID sidecar from #1354 and a real Stream
Deck. They prove USB lifecycle only; live fleet rendering and controls require
separate implementation and terminal evidence in
[#1358](https://github.com/aiur-team/aiur/issues/1358).
