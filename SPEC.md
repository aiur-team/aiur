...
Aiur does not require first-class tracker write APIs in the orchestrator.
...
- `GET /api/v1/<issue_identifier>`
  ...
  - Suggested response shape:
    ...
    ```json
    {
      ...
      "status": "running",
      "workspace": {
        "path": "/tmp/aiur_workspaces/MT-649"
      },
      "attempts": {
        "restart_count": 1,
      ...
      "logs": {
        "codex_session_logs": [
          {
            "label": "latest",
            "path": "/var/log/aiur/codex/MT-649/latest.log",
            "url": null
          }
        ]
      },
...
This appendix describes a common extension profile in which Aiur keeps one central
