defmodule SymphonyElixir.CodingAgentCheckpointTest do
  use SymphonyElixir.TestSupport

  alias SymphonyElixir.Claude.CodingAgent, as: ClaudeAgent
  alias SymphonyElixir.Codex.CodingAgent, as: CodexAgent

  test "Codex adapter starts a queued follow-up turn from a safe checkpoint" do
    test_root = Path.join(System.tmp_dir!(), "symphony-codex-checkpoint-#{System.unique_integer([:positive])}")
  ...
  test "Claude adapter starts a queued follow-up turn from a safe checkpoint" do
    test_root = Path.join(System.tmp_dir!(), "symphony-claude-checkpoint-#{System.unique_integer([:positive])}")
