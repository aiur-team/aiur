defmodule Aiur.TestSupport.Snapshot do
  import ExUnit.Assertions

  @snapshot_root Path.expand("../fixtures", __DIR__)
  @ansi_regex ~r/\e\[[0-9;]*m/

  @update_snapshot_hint "Run `UPDATE_SNAPSHOTS=1 mix test test/aiur/status_dashboard_snapshot_test.exs` to create or update fixtures."
