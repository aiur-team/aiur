-file("src/erlex_parser.yrl", 0).
-module(erlex_parser).
-file("src/erlex_parser.erl", 3).
-export([parse/1, parse_and_scan/1, format_error/1]).
-file("src/erlex_parser.yrl", 137).

unwrap({_,_,V}) -> V.

-file("/Users/kevinweaver/.local/share/mise/installs/erlang/28.5/lib/parsetools-2.7.1/include/yeccpre.hrl", 0).
%%
%% %CopyrightBegin%
%%
