...
- `aiur status` prints the effective value and the live interval per class, for
  ...
  POLL class intervals: ci=120s dispatch=120s firehose=0s planning=0s review=300s
  ```
