...
Aiur enables the dashboard by default and binds it to loopback on a free port. The launch output prints its URL. Pin a private address when you need a stable URL:
