...
Agents classify the requested action, not the subsystem around it. Routine,
...
Aiur raises a warning when a human-required Command is reversible and all of its
